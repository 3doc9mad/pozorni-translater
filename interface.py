...
def window():
    ...
    with dpg.theme() as global_theme:
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_Text, (0, 0, 0), category=dpg.mvThemeCat_Core)  # Цвет текста
        ...
        with dpg.theme_component(dpg.mvImageButton):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (255, 255, 255),
                                category=dpg.mvThemeCat_Core)
            dpg.add_theme_color(dpg.mvThemeCol_Border, (0, 0, 0, 0), tag='button_line', )
            dpg.add_theme_style(dpg.mvStyleVar_FrameRounding, 90)
    with dpg.theme() as button_theme:
        with dpg.theme_component(dpg.mvImageButton):
            dpg.add_theme_color(dpg.mvThemeCol_Border, (198, 48, 62, 255))
    ...
    with dpg.window(label="Автопереводчик", width=450, height=800, no_collapse=False, no_move=True, no_title_bar=True,
        ...
        with dpg.group():
            ...
            dpg.set_item_pos("main_button", [161, 250])
